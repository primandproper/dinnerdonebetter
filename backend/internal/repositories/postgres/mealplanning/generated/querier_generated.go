...
type Querier interface {
	...
	AttachMealPlanFinalizationSaga(ctx context.Context, db DBTX, arg *AttachMealPlanFinalizationSagaParams) (int64, error)
	...
	DeleteMealPlanGroceryListItems(ctx context.Context, db DBTX, ids []string) error
	DeleteMealPlanTasks(ctx context.Context, db DBTX, ids []string) error
	...
	GetAllMealPlanEventsForMealPlans(ctx context.Context, db DBTX, ids []string) ([]*MealPlanEvents, error)
	...
	GetChosenMealNamesForMealPlans(ctx context.Context, db DBTX, ids []string) ([]*GetChosenMealNamesForMealPlansRow, error)
	GetFinalizedMealPlanOptionsForMealPlan(ctx context.Context, db DBTX, mealPlanID string) ([]*GetFinalizedMealPlanOptionsForMealPlanRow, error)
	...
	GetMealPlanIDsVotedOnByUser(ctx context.Context, db DBTX, arg *GetMealPlanIDsVotedOnByUserParams) ([]string, error)
	...
	GetMealPlansAwaitingFinalizationSaga(ctx context.Context, db DBTX, queryLimit int32) ([]*GetMealPlansAwaitingFinalizationSagaRow, error)
	...
	GetValidIngredientMeasurementUnitsByIDs(ctx context.Context, db DBTX, ids []string) ([]*GetValidIngredientMeasurementUnitsByIDsRow, error)
	...
	GetValidIngredientPreparationsByIDs(ctx context.Context, db DBTX, ids []string) ([]*GetValidIngredientPreparationsByIDsRow, error)
	...
	GetValidPreparationInstrumentsByIDs(ctx context.Context, db DBTX, ids []string) ([]*GetValidPreparationInstrumentsByIDsRow, error)
	...
	GetValidPreparationVesselsByIDs(ctx context.Context, db DBTX, ids []string) ([]*GetValidPreparationVesselsByIDsRow, error)
	...
	MarkMealsAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkRecipesAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkValidIngredientStatesAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkValidIngredientsAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkValidInstrumentsAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkValidMeasurementUnitsAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkValidPreparationsAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	MarkValidVesselsAsIndexed(ctx context.Context, db DBTX, ids []string) (int64, error)
	...
	ScanMealIDsForReindex(ctx context.Context, db DBTX, arg *ScanMealIDsForReindexParams) ([]string, error)
	ScanRecipeIDsForReindex(ctx context.Context, db DBTX, arg *ScanRecipeIDsForReindexParams) ([]string, error)
	ScanValidIngredientIDsForReindex(ctx context.Context, db DBTX, arg *ScanValidIngredientIDsForReindexParams) ([]string, error)
	ScanValidIngredientStateIDsForReindex(ctx context.Context, db DBTX, arg *ScanValidIngredientStateIDsForReindexParams) ([]string, error)
	ScanValidInstrumentIDsForReindex(ctx context.Context, db DBTX, arg *ScanValidInstrumentIDsForReindexParams) ([]string, error)
	ScanValidMeasurementUnitIDsForReindex(ctx context.Context, db DBTX, arg *ScanValidMeasurementUnitIDsForReindexParams) ([]string, error)
	ScanValidPreparationIDsForReindex(ctx context.Context, db DBTX, arg *ScanValidPreparationIDsForReindexParams) ([]string, error)
	ScanValidVesselIDsForReindex(ctx context.Context, db DBTX, arg *ScanValidVesselIDsForReindexParams) ([]string, error)
	...
	UnmarkMealPlanGroceryListInitialized(ctx context.Context, db DBTX, id string) error
	UnmarkMealPlanPrepTasksCreated(ctx context.Context, db DBTX, id string) error

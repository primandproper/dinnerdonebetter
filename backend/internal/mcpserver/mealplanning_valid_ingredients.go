...
var validIngredientsSchema = map[string]any{
	...
	fieldCreatedAt:                      timestampField("When the valid ingredient was created"),
	fieldLastUpdatedAt:                  timestampField("When the valid ingredient was last updated"),
	fieldArchivedAt:                     timestampField("When the valid ingredient was soft deleted"),
	fieldName:                           stringField("Name of the ingredient"),
	fieldDescription:                    stringField("Description of the ingredient"),
	...
	fieldPluralName:                     stringField("The plural name for the ingredient. So for an ingredient named 'onion', this would be 'onions'"),
	...
	fieldStorageInstructions:            stringField("Instructions on how to store the item."),
	fieldSlug:                           stringField("An easy-to-use URL slug for the ingredient"),
...
var getValidIngredientTool = &mcp.Tool{
	...
	InputSchema: schemaObject(map[string]any{
		fieldValidIngredientID: stringField("The ID of the valid ingredient to get"),
	}),
...
var searchForValidIngredientsTool = &mcp.Tool{
	...
	InputSchema: schemaObject(map[string]any{
		...
		fieldQuery: map[string]any{
			keyType:        strType,
			keyDescription: "The ingredient name query",
		},
	}),
	OutputSchema: schemaObject(map[string]any{
		fieldResults: arrayType(schemaObject(validIngredientsSchema)),
	}),
}

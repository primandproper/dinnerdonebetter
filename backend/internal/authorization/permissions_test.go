...
func TestPermissions(T *testing.T) {
	...
	T.Run("account admin", func(t *testing.T) {
		...
		assert.False(t, permissionChecker.HasPermission(PermissionUpdateUserStatus))
		assert.False(t, permissionChecker.HasPermission(PermissionReadUsers))
		assert.False(t, permissionChecker.HasPermission(PermissionReadUsers))
		assert.True(t, permissionChecker.HasPermission(PermissionUpdateAccounts))
		assert.True(t, permissionChecker.HasPermission(PermissionArchiveAccounts))
		assert.True(t, permissionChecker.HasPermission(PermissionInviteMembers))
		assert.True(t, permissionChecker.HasPermission(PermissionManageMembers))
		assert.True(t, permissionChecker.HasPermission(PermissionManageMembers))
		assert.True(t, permissionChecker.HasPermission(PermissionTransferAccountOwnership))
	...
	T.Run("account member", func(t *testing.T) {
		...
		assert.False(t, permissionChecker.HasPermission(PermissionReadUsers))
		assert.False(t, permissionChecker.HasPermission(PermissionReadUsers))
		assert.False(t, permissionChecker.HasPermission(PermissionUpdateAccounts))
		assert.False(t, permissionChecker.HasPermission(PermissionArchiveAccounts))
		assert.False(t, permissionChecker.HasPermission(PermissionInviteMembers))
		assert.False(t, permissionChecker.HasPermission(PermissionManageMembers))
		assert.False(t, permissionChecker.HasPermission(PermissionManageMembers))
		assert.False(t, permissionChecker.HasPermission(PermissionTransferAccountOwnership))

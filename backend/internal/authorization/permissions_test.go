...
func TestPermissions(T *testing.T) {
	...
	T.Run("account admin", func(t *testing.T) {
		...
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionUpdateUserStatus)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionReadUsers)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionReadUsers)))
		assert.True(t, permissionChecker.HasPermission(Permission(PermissionUpdateAccounts)))
		assert.True(t, permissionChecker.HasPermission(Permission(PermissionArchiveAccounts)))
		assert.True(t, permissionChecker.HasPermission(Permission(PermissionInviteMembers)))
		assert.True(t, permissionChecker.HasPermission(Permission(PermissionManageMembers)))
		assert.True(t, permissionChecker.HasPermission(Permission(PermissionManageMembers)))
		assert.True(t, permissionChecker.HasPermission(Permission(PermissionTransferAccountOwnership)))
		assert.True(t, permissionChecker.HasPermission(SaveWebhookEndpointsPermission))
		assert.True(t, permissionChecker.HasPermission(ReadWebhookEndpointsPermission))
		assert.True(t, permissionChecker.HasPermission(ArchiveWebhookEndpointsPermission))
		assert.True(t, permissionChecker.HasPermission(RotateWebhookSecretPermission))
		...
		assert.True(t, permissionChecker.HasPermission(CreateRecipesPermission))
		assert.True(t, permissionChecker.HasPermission(CloneRecipesPermission))
	...
	T.Run("account member", func(t *testing.T) {
		...
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionReadUsers)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionReadUsers)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionUpdateAccounts)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionArchiveAccounts)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionInviteMembers)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionManageMembers)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionManageMembers)))
		assert.False(t, permissionChecker.HasPermission(Permission(PermissionTransferAccountOwnership)))
		// A member reads an account's webhooks and changes none of them — the same
		// division "read.webhooks" against the other three expressed before the
		// adoption split each verb into its own permission.
		assert.False(t, permissionChecker.HasPermission(SaveWebhookEndpointsPermission))
		assert.True(t, permissionChecker.HasPermission(ReadWebhookEndpointsPermission))
		assert.False(t, permissionChecker.HasPermission(ArchiveWebhookEndpointsPermission))
		assert.False(t, permissionChecker.HasPermission(RotateWebhookSecretPermission))
		assert.False(t, permissionChecker.HasPermission(CreateValidInstrumentsPermission))
		assert.True(t, permissionChecker.HasPermission(ReadValidInstrumentsPermission))
		assert.True(t, permissionChecker.HasPermission(SearchValidInstrumentsPermission))
		assert.False(t, permissionChecker.HasPermission(UpdateValidInstrumentsPermission))

...
// Regenerate the moq mocks via `go generate ./internal/domain/identity/manager/mock/`.

//go:generate go tool github.com/matryer/moq -out identity_manager_mock.go -pkg mock -rm -fmt goimports .. IdentityDataManager:IdentityDataManagerMock

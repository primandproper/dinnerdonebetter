...
// Regenerate the moq mocks via `go generate ./internal/domain/webhooks/manager/mock/`.

//go:generate go tool github.com/matryer/moq -out webhooks_manager_mock.go -pkg mock -rm -fmt goimports .. WebhookDataManager:WebhookDataManagerMock

...
// Regenerate the moq mocks via `go generate ./internal/domain/oauth/manager/mock/`.

//go:generate go tool github.com/matryer/moq -out oauth_manager_mock.go -pkg mock -rm -fmt goimports .. OAuth2Manager:OAuth2ManagerMock

...
const (
	...
	// ServicePaymentsCapitalismRevenuecatWebhookSecretEnvVarKey is the environment variable name
	// to set to override `APIServiceConfig.Services.Payments.Capitalism.RevenueCat.WebhookSecret`.
	ServicePaymentsCapitalismRevenuecatWebhookSecretEnvVarKey = "DINNER_DONE_BETTER_SERVICE_PAYMENTS_CAPITALISM_REVENUECAT_WEBHOOK_SECRET"

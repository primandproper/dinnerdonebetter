...
func ProvideMethodPermissions() AuthMethodPermissions {
	return AuthMethodPermissions{
		...
		authsvc.AuthService_UpdateUserEmailAddress_FullMethodName:        noPerms,
		authsvc.AuthService_UpdateUserUsername_FullMethodName:            noPerms,
		authsvc.AuthService_RegisterUser_FullMethodName:                  noPerms,

...
import (
	platformauth "github.com/primandproper/platform-go/v13/authentication"
...
// Re-exports of types that now live in github.com/primandproper/platform-go/v13/authentication.

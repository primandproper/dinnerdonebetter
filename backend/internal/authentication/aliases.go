...
import (
	platformauth "github.com/primandproper/platform-go/v8/authentication"
...
// Re-exports of types that now live in github.com/primandproper/platform-go/v8/authentication.

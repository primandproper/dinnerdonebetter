...
var fieldExceptions = map[string]map[string]Rule{
	...
	"ConvertRecipeStepIngredientToRecipeStepIngredientDatabaseCreationInput": {
		fieldProductOfRecipeStepIndex:        Skip(recipeCreationIndex),
		fieldProductOfRecipeStepProductIndex: Skip(recipeCreationIndex),
		"ValidIngredientPreparationID":       Skip(bridgeRowID),
		"ValidIngredientMeasurementUnitID":   Skip(bridgeRowID),
		fieldScaleFactor:                     Expr("scaleFactorOrDefault(x.ScaleFactor)", scaleFactorDefaulted),
	},
...
const (
	...
	fieldProductOfRecipeStepProductIndex = "ProductOfRecipeStepProductIndex"
	fieldScaleFactor                     = "ScaleFactor"
	fieldValidMeasurementUnitID          = "ValidMeasurementUnitID"
)
